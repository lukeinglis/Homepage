...
function Particles({ count=40, color="rgba(255,255,255,0.5)", spd=18, size=2 }) {
...
function BgBeaconHill() {
  return (
    <div className="absolute inset-0 grain" aria-hidden style={{overflow:"hidden"}}>
      ...
      <div className="absolute font-mono text-[10px] tracking-[0.22em] uppercase" style={{ right: 22, bottom: 18, color: "rgba(255,225,200,0.7)" }}>Beacon Hill · Acorn Street · 7:42 AM</div>
    </div>
  );
}
...
function BgSeaport() {
  return (
    <div className="absolute inset-0 grain" aria-hidden style={{overflow:"hidden"}}>
      ...
      <div className="absolute font-mono text-[10px] tracking-[0.22em] uppercase" style={{ right: 22, bottom: 18, color: "rgba(255,220,180,0.7)" }}>Boston · Seaport · 6:18 PM · light rain</div>
    </div>
  );
}

// ───────────────── Wknd morning — coastal Cape vibe ───────────────────
function BgCapeMorning() {
  return (
    <div className="absolute inset-0 grain" aria-hidden style={{overflow:"hidden"}}>
      ...
      <div className="absolute font-mono text-[10px] tracking-[0.22em] uppercase" style={{ right: 22, bottom: 18, color: "rgba(40,30,20,0.65)" }}>Cape Cod · Saturday · 9:14 AM</div>
    </div>
  );
}

// ───────────────── Wknd evening — North End restaurant block ──────────
function BgNorthEnd() {
  return (
    <div className="absolute inset-0 grain" aria-hidden style={{overflow:"hidden"}}>
      <div className="absolute inset-0" style={{
      ...
      <div className="absolute font-mono text-[10px] tracking-[0.22em] uppercase" style={{ right: 22, bottom: 18, color: "rgba(255,220,180,0.7)" }}>North End · Hanover Street · 7:52 PM</div>
    </div>
  );
}
...
function BgAuburn() {
  return (
    <div className="absolute inset-0 grain" aria-hidden style={{overflow:"hidden"}}>
      ...
      <div className="absolute font-mono text-[10px] tracking-[0.22em] uppercase" style={{ right: 22, bottom: 18, color: "rgba(255,235,200,0.75)" }}>Toomer's Corner · Auburn · War Eagle</div>
    </div>
  );
}
...
function BgChelsea() {
  return (
    <div className="absolute inset-0 grain" aria-hidden style={{overflow:"hidden"}}>
      ...
      <div className="absolute font-mono text-[10px] tracking-[0.22em] uppercase" style={{ right: 22, bottom: 18, color: "rgba(220,235,255,0.75)" }}>Stamford Bridge · Chelsea · matchday</div>
    </div>
  );
}
...
function BgCamden() {
  return (
    <div className="absolute inset-0 grain" aria-hidden style={{overflow:"hidden"}}>
      ...
      <div className="absolute font-mono text-[10px] tracking-[0.22em] uppercase" style={{ right: 22, bottom: 18, color: "rgba(255,210,170,0.75)" }}>Camden Yards · Orioles · first pitch 7:05</div>
    </div>
  );
}
...
function BgKeyWest() {
  return (
    <div className="absolute inset-0 grain" aria-hidden style={{overflow:"hidden"}}>
      ...
      <div className="absolute font-mono text-[10px] tracking-[0.22em] uppercase" style={{ right: 22, bottom: 18, color: "rgba(255,220,180,0.8)" }}>Key West · Mallory Square · sunset hour</div>
    </div>
  );
}
...
function BgSki() {
  return (
    <div className="absolute inset-0 grain" aria-hidden style={{overflow:"hidden"}}>
      ...
      <Snow count={70}/>
      <div className="absolute font-mono text-[10px] tracking-[0.22em] uppercase" style={{ right: 22, bottom: 18, color: "rgba(40,40,60,0.7)" }}>Stowe · Vermont · fresh powder</div>
    </div>
  );
}

window.BgWeekdayAM = BgBeaconHill;
window.BgWeekdayPM = BgSeaport;
window.BgWeekendAM = BgCapeMorning;
window.BgWeekendPM = BgNorthEnd;
window.BgAuburn  = BgAuburn;
window.BgChelsea = BgChelsea;
window.BgCamden  = BgCamden;
window.BgKeyWest = BgKeyWest;
window.BgSki     = BgSki;
